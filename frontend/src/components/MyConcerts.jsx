...
const MyConcerts = () => {
  ...
  const fetchMyConcerts = async (headers) => {
      try {
        const response = await axios.get("http://https://ticketmestarbackend-yqpn.onrender.com/concerts/me", { withCredentials:true,headers });
  ...
  const deleteConcert = async (concertId, headers) => {
    try {
      await axios.post(`http://https://ticketmestarbackend-yqpn.onrender.com/concerts/delete?concertId=${concertId}`, {}, { withCredentials: true, headers });
